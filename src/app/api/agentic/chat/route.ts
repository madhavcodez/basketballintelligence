...
5. team_game_logs (SEASON_ID TEXT, TEAM_ID INT, TEAM_ABBREVIATION TEXT, TEAM_NAME TEXT, GAME_DATE TEXT, WL TEXT, PTS INT, REB INT, AST INT, STL INT, BLK INT, TOV INT, FG_PCT REAL, FG3_PCT REAL, FT_PCT REAL)
6. team_stats_advanced (Season TEXT, TEAM_NAME TEXT, GP INT, W INT, L INT, OFF_RATING REAL, DEF_RATING REAL, NET_RATING REAL, PACE REAL, TS_PCT REAL, EFG_PCT REAL)
...
10. lineups (GROUP_NAME TEXT, TEAM_ABBREVIATION TEXT, GP INT, W INT, L INT, MIN REAL, PTS REAL, AST REAL, REB REAL, PLUS_MINUS REAL, FG_PCT REAL, FG3_PCT REAL, season TEXT)
